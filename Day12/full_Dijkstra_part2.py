...
def myshow(tree):
    ...
    board[start_coordinates[0],start_coordinates[1]] = -10
    while tree[par].tag != start_coordinates:
        # print(tree[par].tag)
...
for line in lines:
    ...
    for c in line:
        # find START
        if c == 'S':
            end_coordinates.append((line_index,c_index))
...
while not end_flag:
    ...
    # if I arrived end
    elif tree[current_node].tag in end_coordinates:
        end_flag = 1 # positive ending

print(end_coordinates[1300:1310])
if end_flag == 1:
